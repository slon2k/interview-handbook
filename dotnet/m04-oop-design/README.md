...
- Unit, integration, and end-to-end testing belong in [Module 11 - Testing and Testability](../m11-testing-and-testability/README.md), although testability is a design concern here.
- Large-scale architecture and distributed-system trade-offs belong in [Module 14 - Architecture and System Design Fundamentals](../m14-architecture-and-system-design/README.md).
